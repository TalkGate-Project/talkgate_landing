...
export function IntroduceView({ storyItems }: IntroduceViewProps) {
  return (
    <div className="pb-[60px] md:pb-[132px]">
          ...
          <div className="relative rounded-xl md:rounded-2xl overflow-hidden bg-gradient-to-br from-neutral-800 to-neutral-900 text-white mb-[30px] md:mb-[50px] h-[400px] md:h-[526px]">
            ...
            <div className="absolute inset-0 z-0 introduce-hero-image">
              <Image
                ...
                fill
                className="object-cover md:object-right introduce-hero-image-position"
                priority
              />
              {/* 모바일에서 이미지 위치 조정: globals.css에서 .introduce-hero-image-position 클래스의 object-position 값을 변경하여 원하는 부분을 보여줄 수 있습니다 */}
              {/* 예: 0% (왼쪽 끝), 20% (왼쪽에서 20%), 50% (중앙), 75% 등 */}
      ...
      {/* Story Section */}
      <section className="pt-[30px] px-4 md:px-0">
        <div className="md:max-w-[1200px] mx-auto">
          <h2 className="text-[32px] md:text-[48px] font-bold leading-[1.5] tracking-[-0.03em] text-[#252525] !mb-[20px] md:!mb-[26px]">
            Our Story
          </h2>
...
function StoryCard({ item, index }: { item: TimelineItem; index: number }) {
  return (
    <div className="w-full md:w-auto max-w-[327px] md:max-w-none mx-auto md:mx-0">
      {/* 모바일: 카드 형식, 데스크톱: 기존 레이아웃 */}
      <div className="md:hidden flex flex-col rounded-[20px] overflow-hidden bg-[#F8F8F8]">
        {/* 이미지 영역 */}
        <div className="relative w-full h-[180px] rounded-t-[16px] overflow-hidden">
          <Image
          ...
          <div className="absolute inset-0 flex items-center justify-center z-10">
            <svg
              ...
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
              className="w-[100px] h-[24px] opacity-50"
            >
              <g opacity="0.5">
                <path
        ...
        {/* 텍스트 영역 */}
        <div className="bg-[#F8F8F8] rounded-b-[20px] px-[12px] py-4 h-[100px] flex flex-col justify-center">
          <h3 className="text-[16px] font-bold leading-[150%] tracking-[-0.03em] text-[#000000] mb-2">
            {item.title}
          </h3>
          <p className="text-[13px] font-medium leading-[150%] tracking-[-0.03em] text-[#808080]">
            {item.date}
          </p>
        </div>
      </div>
      ...
      {/* 데스크톱: 기존 레이아웃 */}
      <div className="hidden md:flex flex-row justify-between items-center gap-6 pl-[44px] pr-0 py-0 h-[180px] rounded-xl bg-muted overflow-hidden">
        <div className="flex-1">
          <h3 className="text-[24px] font-bold leading-[1.5] tracking-[-0.03em] text-[#000] !mb-4">
            {item.title}
          </h3>
          <p className="text-[18px] font-medium leading-[1.5] tracking-[-0.03em] text-[#808080]">
            {item.date}
          </p>
        </div>
        <div className="h-full w-auto flex-shrink-0 overflow-hidden flex items-center justify-center relative">
