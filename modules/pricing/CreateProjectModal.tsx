...
export default function CreateProjectModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-[14px] shadow-[0px_13px_61px_rgba(169,169,169,0.37)] w-full max-w-[520px] md:max-w-[640px] max-h-[90vh] flex flex-col md:min-h-[597px]">
        {/* Header */}
        ...
        {/* Step indicator */}
        <div className="flex flex-col items-center mb-4 md:mb-6 px-5 md:px-7">
          ...
          <div className="flex items-center justify-center gap-[52px] md:gap-[68px] mt-2">
            <span className={`text-[14px] font-medium ${step >= 1 ? "text-[#00E272]" : "text-[#808080]"}`}>
              기본정보
            </span>
            <span className={`text-[14px] font-medium ${step >= 2 ? "text-[#00E272]" : "text-[#808080]"}`}>
              도메인 설정
            </span>
          </div>
        </div>
        ...
        {/* Content */}
        <div className="flex-1 overflow-y-auto px-5 md:px-7 pb-4">
          {step === 1 ? (
            ...
            <div className="space-y-4">
              ...
              <div className="rounded-[8px] bg-[#F8F8F8] px-4 md:px-6 py-4 flex flex-col md:flex-row md:items-center justify-between gap-3">
                <div className="flex-1">
                  ...
                  <div className="text-[14px] font-medium text-[#808080] leading-[1.6]">
                    이 단계를 건너뛰면 무작위 도메인이 자동으로 생성됩니다. 언제든지 설정 &gt; 일반에서 변경할 수 있습니다.
                  </div>
                </div>
                <button
                  type="button"
