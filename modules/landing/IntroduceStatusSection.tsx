...
export function IntroduceStatusSection() {
  ...
  return (
    <section className="py-12 md:py-20 px-4 md:px-6 lg:px-4" ref={sectionRef}>
      <div className="max-w-[1200px] mx-auto">
        <div className="text-center mb-5 md:mb-16">
          ...
          <h2 className="text-[20px] md:text-[32px] leading-[1.5] tracking-[-0.03em] font-bold">
            성과 랭킹을 공개하여<br className="md:hidden" /> 목표 달성을 촉진하세요.
          </h2>
        </div>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-10 lg:gap-[70px]">
          <div className={`bg-[#F6F6F6] rounded-[16px] text-center px-4 md:px-6 md:!px-[36px] pt-4 md:pt-8 md:!pt-[58px] pb-4 md:pb-0 w-full md:max-w-[550px] lg:max-w-none md:mx-auto md:min-h-[570px] status-card-left ${isVisible ? 'animate' : ''}`}>
            <Image
          ...
          <div className={`bg-[#F6F6F6] rounded-[16px] text-center px-4 md:px-6 md:!px-[36px] pt-4 md:pt-8 md:!pt-[58px] pb-4 md:pb-0 w-full md:max-w-[550px] lg:max-w-none md:mx-auto md:min-h-[570px] status-card-right ${isVisible ? 'animate' : ''}`}>
            <Image
