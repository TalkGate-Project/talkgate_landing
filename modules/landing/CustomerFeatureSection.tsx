        ...
        <div className="text-center mb-16">
          ...
          <div className="flex flex-col lg:flex-row gap-8 items-start">
            ...
            <div className="flex-1 w-full">
              <div className="w-[368px] h-[56px] relative inline-flex bg-neutral-20 rounded-full">
              ...
              <div className="text-left">
                {activeTab === "list" ? (
                  <>
                    <h2>고객 데이터를 체계적으로 관리하고 확인하세요.</h2>
                    <ul>
                      <li>
                        <div className="flex gap-3">
                          ...
                          <span>원하는 고객 데이터를 한 번에 검색 및 조회</span>
                        </div>
                      </li>
                      <li>
                        <div className="flex gap-3">
                          ...
                          <span>고객 배정 상태 및 진행 현황 실시간 파악</span>
                        </div>
                      </li>
                      <li>
                        <div className="flex gap-3">
                          ...
                          <span>고객별 중요 활동 기록 및 히스토리 관리</span>
                        </div>
                      </li>
                    </ul>
                  </>
                  ...
                  <>
                    <h2>클릭으로 고객 정보를 조회, 편집하여 활용하세요.</h2>
                    <ul>
                      <li>
                        <div className="flex gap-3">
                          <svg
                      ...
                      <li>
                        <div className="flex gap-3">
                          ...
                          <span>고객 정보를 이용하여 맞춤형 케어 제공</span>
                        </div>
                      </li>
                    </ul>
                  </>
