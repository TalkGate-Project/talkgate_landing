      ...
      <div className="w-full max-w-[1170px]">
        <div className="mb-11">
          ...
          <h2 className="text-[32px] leading-[1.5] tracking-[-0.03em] font-bold">
            사용자 데이터 보호를 최우선으로, 안정적인 시스템을 운영합니다.
          </h2>
        </div>
        <ul className="flex h-[394px] gap-6">
          <li className={`flex-1 security-card ${isVisible ? 'animate' : ''}`}>
            ...
            >
              ...
              <h3 className="text-[16px] text-[#00B55B] leading-[1.5] tracking-[-0.02em] font-bold !mb-2 z-10">
                KISA 보안 기준 기반의 내부 보안 점검 완료
              </h3>
              <p className="text-[16px] leading-[1.5] tracking-[-0.02em] text-[#252525] font-medium h-[72px] z-10">
                한국인터넷진흥원(KISA)에서 제시한 클라우드 <br />
                보안 가이드라인을 기준으로 내부 보안 점검을 <br />
                수행해 안정적인 환경을 유지하고 있어요.
              </p>
              <h3 className="text-[16px] text-[#00B55B] leading-[1.5] tracking-[-0.02em] font-bold !mb-2 z-10 !mt-[30px]">
                물리적·네트워크 기반 접근 통제
              </h3>
              <p className="text-[16px] leading-[1.5] tracking-[-0.02em] text-[#252525] font-medium h-[72px] z-10">
                내부 데이터베이스는 지정된 IP에서만 접근이 가능 <br />
          ...
          <li className={`flex-1 security-card ${isVisible ? 'animate' : ''}`} style={{ animationDelay: '0.15s' }}>
            ...
            >
              ...
              <p className="text-[16px] leading-[1.5] tracking-[-0.02em] text-[#252525] font-medium h-[72px] z-10">
                조직 내 역할에 따라 접근 가능한 기능과 데이터가 <br />
                자동으로 구분돼요.
              </p>
              <h3 className="text-[16px] text-[#00B55B] leading-[1.5] tracking-[-0.02em] font-bold !mb-2 z-10 !mt-[30px]">
                조직도 기반 접근 제한
          ...
          <li className={`flex-1 security-card ${isVisible ? 'animate' : ''}`} style={{ animationDelay: '0.3s' }}>
            ...
            >
              ...
              <p className="text-[16px] leading-[1.5] tracking-[-0.02em] text-[#252525] font-medium h-[48px] z-10">
                모든 통신은 암호화되어 제3자가 데이터를 탈취
                <br />
                하더라도 복호화가 불가능합니다.
              </p>
              <h3 className="text-[16px] text-[#00B55B] leading-[1.5] tracking-[-0.02em] font-bold !mb-2 z-10 !mt-[10px]">
                데이터 보안
              </h3>
              <p className="text-[16px] leading-[1.5] tracking-[-0.02em] text-[#252525] font-medium h-[48px] z-10">
                저장되는 데이터는 보안 키로 암호화되어 내부 <br />
                직원도 임의로 접근할 수 없습니다.
              </p>
              <h3 className="text-[16px] text-[#00B55B] leading-[1.5] tracking-[-0.02em] font-bold !mb-2 z-10 !mt-[10px]">
                데이터 관리
